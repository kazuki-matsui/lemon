...
export default function tokenize(sourceCode: string) {
    ...
    while(source.length > 0) {
        if(source[0] == "(") {
        ...
        } else if(source[0] == "&" || source[0] == "|" ||source[0] == ">" || source[0] == "<" || source[0] == "+" || source[0] == "-" || source[0] == "*" || source[0] == "/" || source[0] == "%" || source[0] == "^") {
            tokens.push(token(source.shift(), TokenType.BinaryOperator))
        } else if((source[0] == "!" && source[1] == "=") || (source[0] == "=" && source[1] == ">") || (source[0] == "<" && source[1] == "=") || (source[0] == "=" && source[1] == "=")) {
            ...
            if(source[0] == "'" || source[0] == '"') {
                ...
                if(tokens[tokens.length - 1]?.type == TokenType.Constant) {
                ...
                } else if(alphabeticalCharacter == "constant") {
                        tokens.push(token(alphabeticalCharacter, TokenType.Constant))
                } else if(alphabeticalCharacter == "object") {
                    tokens.push(token(alphabeticalCharacter, TokenType.Object))
                } else if((alphabeticalCharacter == "if" || alphabeticalCharacter == "otherwise" || alphabeticalCharacter == "every" || alphabeticalCharacter == "repeat" || alphabeticalCharacter == "while")) {
                ...
                } else if(alphabeticalCharacter == "import") {
